  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 to-primary-container px-4 py-6">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-6 sm:p-8">
        <h1 className="text-2xl font-bold text-neutral-900 mb-2">{t('auth.forgot.title', language)}</h1>
        <p className="text-sm text-neutral-600 mb-6">{t('auth.forgot.description', language)}</p>
        ...
        {submitted ? (
          <div className="space-y-4">
            ...
            <a className="text-primary-600 underline underline-offset-4" href="/login">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-neutral-700 mb-2">{t('auth.forgot.emailLabel', language)}</label>
              <input
                type="email"
                value={email}
            ...
            <div className="text-center">
              <a className="text-sm text-neutral-600 underline underline-offset-4" href="/login">
                {t('auth.forgot.backToLogin', language)}
              </a>
            </div>
          </form>
