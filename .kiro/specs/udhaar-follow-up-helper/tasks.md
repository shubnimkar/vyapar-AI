...
- [ ] 1. Set up core data types and translation keys
...
- [ ] 2. Implement Credit Manager (deterministic core)
  - [ ] 2.1 Create lib/credit-manager.ts with pure calculation functions
  ...
  - [ ]* 2.2 Write property test for days overdue calculation
  ...
  - [ ]* 2.3 Write property test for overdue credit filtering
  ...
  - [ ]* 2.4 Write property test for urgency-based sorting
  ...
  - [ ]* 2.5 Write property test for deterministic calculation
  ...
  - [ ]* 2.6 Write unit tests for Credit Manager edge cases
...
- [ ] 3. Checkpoint - Ensure Credit Manager tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 4. Implement WhatsApp Link Generator
  - [ ] 4.1 Create lib/whatsapp-link-generator.ts
  ...
  - [ ]* 4.2 Write property test for WhatsApp URL structure
  ...
  - [ ]* 4.3 Write property test for reminder message content
  ...
  - [ ]* 4.4 Write property test for language-based message selection
  ...
  - [ ]* 4.5 Write unit tests for WhatsApp Link Generator
...
- [ ] 5. Implement Reminder Tracker
  - [ ] 5.1 Create lib/reminder-tracker.ts
  ...
  - [ ]* 5.2 Write property test for reminder timestamp recording
  ...
  - [ ]* 5.3 Write property test for days since reminder calculation
  ...
  - [ ]* 5.4 Write property test for dual persistence updates
  ...
  - [ ]* 5.5 Write unit tests for Reminder Tracker
...
- [ ] 6. Checkpoint - Ensure core libraries tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 7. Extend Credit Sync Service
  - [ ] 7.1 Update lib/credit-sync.ts with reminder tracking support
  ...
  - [ ]* 7.2 Write property test for sync data consistency
    - **Property 16: Sync Data Consistency**
    - **Validates: Requirements 6.2**
    - Test that DynamoDB record contains identical values to localStorage entry
    - Use fast-check with credit entry generators (100 iterations)

  - [ ]* 7.3 Write property test for last-write-wins conflict resolution
  ...
  - [ ]* 7.4 Write property test for DynamoDB key format
  ...
  - [ ]* 7.5 Write property test for complete field persistence
    - **Property 18: Complete Field Persistence**
    - **Validates: Requirements 6.5**
    - Test that all required fields are saved to DynamoDB
    - Use fast-check with credit entry generators (100 iterations)

  - [ ]* 7.6 Write unit tests for Credit Sync Service
...
- [ ] 8. Create API endpoints
  - [ ] 8.1 Create app/api/credit/overdue/route.ts
  ...
  - [ ] 8.2 Create app/api/credit/reminder/route.ts
...
- [ ] 10. Implement Follow-Up Panel UI component
  - [ ] 10.1 Create components/FollowUpPanel.tsx
  ...
  - [ ]* 10.2 Write property test for overdue credit display fields
...
- [ ] 11. Add WhatsApp reminder functionality to Follow-Up Panel
  - [ ] 11.1 Add WhatsApp reminder button to each credit item
  ...
  - [ ]* 11.2 Write property test for conditional WhatsApp button rendering
    - **Property 7: Conditional WhatsApp Button Rendering**
    - **Validates: Requirements 3.3, 3.4**
    - Test that button appears if and only if phoneNumber exists
    - Use React Testing Library with fast-check (100 iterations)

  - [ ]* 11.3 Write unit tests for WhatsApp reminder functionality
...
- [ ] 12. Add reminder history display to Follow-Up Panel
  - [ ] 12.1 Display last reminder date for each credit
...
- [ ] 13. Add mark as paid functionality to Follow-Up Panel
  - [ ] 13.1 Add "Mark as Paid" button to each credit item
...
- [ ] 14. Checkpoint - Ensure Follow-Up Panel tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 15. Implement multi-language support
  - [ ] 15.1 Add language preference handling to Follow-Up Panel
  ...
  - [ ]* 15.2 Write property test for UI language translation
  ...
  - [ ]* 15.3 Write property test for language change reactivity
  ...
  - [ ]* 15.4 Write unit tests for multi-language support
...
- [ ] 16. Implement offline-first functionality
  - [ ] 16.1 Add offline mode handling to Follow-Up Panel
...
- [ ] 17. Add error handling and validation
  - [ ] 17.1 Implement error handling in Follow-Up Panel
...
- [ ] 18. Add Follow-Up Panel summary section
  - [ ] 18.1 Implement FollowUpSummary display
  ...
  - [ ]* 18.2 Write unit tests for summary section
...
- [ ] 19. Checkpoint - Ensure all component tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 20. Integration and wiring
  - [ ] 20.1 Integrate Follow-Up Panel into main application
  ...
  - [ ] 20.2 Update existing credit entry form to include phone number field
    - Add optional phoneNumber field to CreditTracking component
    - Validate phone number format (10 digits)
    - Store phone number in localStorage and DynamoDB
    - _Requirements: 3.3, 6.5_

  - [ ] 20.3 Update DynamoDB schema to include lastReminderAt field
